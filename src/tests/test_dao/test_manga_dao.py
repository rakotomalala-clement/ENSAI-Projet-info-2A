...
def test_trouver_par_titre_true():
    ...
    titre_manga = "titre1"
    manga = MangaDao().trouver_par_titre(titre_manga, "projet_test_dao")
...
def test_trouver_id_par_titre_true():
    ...
    titre_manga = "titre1"
    id_manga = MangaDao().trouver_id_par_titre(titre_manga, "projet_test_dao")
...
def test_ajouter_manga_true():
    ...
    creation = MangaDao().ajouter_manga(manga, "projet_test_dao")
    ...
    suppression = MangaDao().supprimer_manga(manga, "projet_test_dao")
...
def test_supprimer_manga_ok():
    ...
    manga = MangaDao().trouver_par_titre("titre2", "projet_test_dao")
...
def test_supprimer_ko():
    ...
    suppression = MangaDao().supprimer_manga(manga, "projet_test_dao") if manga else False
