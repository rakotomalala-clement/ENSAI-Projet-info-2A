...
def test_ajouter_manga_collection_physique_ok():
    """Test de l'ajout de deux mangas à une collection physique pour un utilisateur existant"""
    dao_collection = DaoCollection()
...
def test_creer_collection_coherente_ok(collections):
    """Test de la création de deux collections cohérentes pour un utilisateur existant."""
    dao_collection = DaoCollection()
...
def test_recuperer_mangas_collection_coherente_ok(collections):
    """Test de la récupération de tous les mangas d'une collection cohérente"""
...
def test_supprimer_manga_col_coherente_ok(collections):
    """Test de la suppression d'un manga d'une collection cohérente"""
    ...
    id_manga = dao_manga.trouver_id_par_titre(schema="projet_test_dao", titre=liste_mangas[0].titre)
...
def test_supprimer_manga_col_physique_ok(collections):
    """Test de la suppression d'un manga de la collection physique"""
    _, _, collection = collections
    dao_collection = DaoCollection()
    dao_manga = MangaDao()
