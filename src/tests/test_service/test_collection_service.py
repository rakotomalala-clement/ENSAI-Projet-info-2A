...
#     service_collection.supprimer_collection(result, "Physique", schema="projet_test_dao")
...
#     result_dict = service_collection.rechercher_collections_et_mangas_par_user(
#         id_utilisateur=1, schema="projet_test_dao"
#     )
...
# def test_ajouter_mangas_collection_coherente_ok(service_collection):
#     liste_mangas = [1, 2, 3]
#     result = service_collection.ajouter_mangas_collection_coherente(
#         collection_id=1, liste_mangas=liste_mangas, schema="projet_test_dao"
#     )
...
#     print(collection_physique.id_collection)
#     result = service_collection.supprimer_collection(
